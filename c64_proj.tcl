...
#
# c64_proj.tcl: Tcl script for re-creating project 'block_test_live'
#
# Generated by Vivado on Wed Nov 14 15:54:25 SAST 2018
...
#
# 1. This project restoration tcl script (c64_proj.tcl) that was generated.
#
...
# Create project
create_project c64fpga ./c64fpga -part xc7z010clg400-1
...
set obj [get_projects c64fpga]
set_property -name "board_part" -value "digilentinc.com:zybo:part0:1.0" -objects $obj
set_property -name "default_lib" -value "xil_defaultlib" -objects $obj
set_property -name "ip_cache_permissions" -value "read write" -objects $obj
set_property -name "ip_output_repo" -value "$proj_dir/c64fpga.cache/ip" -objects $obj
...
set files [list \
 ...
 "[file normalize "$origin_dir/src/bd/ip/design_1_axi_smc_0/design_1_axi_smc_0.xci"]"\
 "[file normalize "$origin_dir/src/bd/ip/design_1_ps7_0_axi_periph_0/design_1_ps7_0_axi_periph_0.xci"]"\
 "[file normalize "$origin_dir/src/bd/ip/design_1_clk_wiz_1_0/design_1_clk_wiz_1_0.xci"]"\
 "[file normalize "$origin_dir/src/bd/ip/design_1_xbar_1/design_1_xbar_1.xci"]"\
 "[file normalize "$origin_dir/src/bd/ip/design_1_auto_pc_1/design_1_auto_pc_1.xci"]"\
 "[file normalize "$origin_dir/src/bd/ip/design_1_block_test_0_1/design_1_block_test_0_1.xci"]"\
]
...
set file "[file normalize "$origin_dir/src/constr/design_1_wrapper.xdc"]"
set file_added [add_files -norecurse -fileset $obj $file]
set file "$origin_dir/src/constr/design_1_wrapper.xdc"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj

# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/src/constr/vga.xdc"]"
set file_added [add_files -norecurse -fileset $obj $file]
set file "$origin_dir/src/constr/vga.xdc"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj
...
set obj [get_filesets constrs_1]
set_property -name "target_constrs_file" -value "$origin_dir/src/constr/design_1_wrapper.xdc" -objects $obj
...
puts "INFO: Project created: C64FPGA"
